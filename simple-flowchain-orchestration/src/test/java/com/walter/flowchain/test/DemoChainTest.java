package com.walter.flowchain.test;

import com.walter.flowchain.test.activity.DemoActivityChain;
import com.walter.flowchain.test.common.BaseTests;
import com.walter.flowchain.test.common.DemoChainContextKey;
import com.walter.flowchain.test.pay.DemoPayVipChain;
import com.walter.flowchain.test.pay.bo.DemoPayVipChainReq;
import com.walter.flowchain.test.pay.bo.DemoPayVipChainRes;
import com.walter.orchestration.base.ChainContext;
import com.walter.flowchain.test.activity.bo.DemoActivityChainReq;
import com.walter.flowchain.test.activity.bo.DemoActivityChainRes;
